...
personas:
  ...
  items:      
    ...
    - name : "지역 대중 교통 노선"
      ...
      content : "버스 지도와 같은 대중 교통 노선을 확인하세요"

    - name : "에너지 포인트를 통한 유틸리티"
      ...
      content : "최상의 거래를 얻기 위해 유틸리티 공급 업체를 비교하고 대조하세요"
    ...
    - name : "직업"
      ...
      content : "포인트로 지불되는 직업을 찾거나 게시하세요"
    ...
    - name : "시장"
      ...
      content : "포인트를 수락하는 판매자, 트레이너 및 방 임대를 찾으세요"
...
how:
  ...
  steps:
    - image: "/screens/register.png"
      id: 1
      content: "대기 목록 앱에 등록하고 귀하의 도시를 지정합니다"
    - image: "/screens/po2.jpg"
      id: 2
      content: "앱이 귀하의 도시에 사용 가능해지면 알려드리겠습니다"
    - image: "/screens/po3.jpg"
      id: 3
      content: "포인트 거래를 위해 앱을 사용하세요"


req:
  title: 공화국의 책 5장 2절의 요구 사항을 기반으로 합니다
