...
features:
  ...
  items:      
    - name : "Points Banking"
      ...
      content : "Gamitin ang iyong mga punto sa mga 3rd party"

    - name : "Mga Ruta ng Lokal na Transportasyon"
      ...
      content : "Tingnan ang mga ruta ng pampublikong transportasyon, tulad ng isang mapa ng bus"

    - name : "Utilities Gamit ang Puntos ng Enerhiya"
      ...
      content : "Ihambing at ikumpara ang mga utilities upang makakuha ng pinakamabuting deal"      
    ...
    - name : "Trabaho"
      ...
      content : "Maghanap o mag-post ng mga trabahong nagbabayad sa mga punto"
    ...
    - name : "Mga Merkado"
      ...
      content : "Hanapin ang mga nagbebenta, mga tagapagturo, at mga upahan ng kwarto na tumatanggap ng mga puntos"
    ...
    - name : "Mga Kaganapan"
      ...
      content : "Hanapin ang mga kaganapan sa iyong lungsod"
...
how:
  ...
  steps:
    - image: "/screens/register.png"
      id: 1
      content: "Magrehistro sa waitlist app at ilista ang iyong lungsod"
    - image: "/screens/po2.jpg"
      id: 2
      content: "Iaabiso ka namin kapag handa na ang app para sa iyong lungsod"
    - image: "/screens/po3.jpg"
      id: 3
      content: "Gamitin ang app para sa mga trisaksyon ng mga puntos"


req:
  title: Batay sa Aklat 5, Kabanata 2 ng Republic ni Plato 
...
cta:
  enable : true
  title : "Gusto mo bang subukan ang City?"
  link1text: "Oo naman!"
